...
subroutine geoq_psilimiter(self)
  ...
  call log_value("SMARDDA-BEQ psiltr ",self%beq%psiltr)
  call log_value("SMARDDA-BEQ rbdry ",self%beq%rbdry)
  call log_value("SMARDDA-BEQ bpbdry ",self%beq%bpbdry)
  call log_value("SMARDDA-BEQ btotbdry ",self%beq%btotbdry)
