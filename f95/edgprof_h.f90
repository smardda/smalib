...
!> type storing edge profile data
  type, public :: edgprof_t
     ...
     real(kr8) :: lmid !< decay length
     real(kr8) :: ploss !< power loss
     real(kr8) :: sigma !< diffusion length
     ...
     real(kr8) :: rblfac !< factor \f$ \frac{1}{2 \pi \lambda_{mid} R_m B_{pm}} \f$
     real(kr8) :: fpfac !< factor \f$ \frac{F P_{loss}}}{2 \pi \lambda_{mid} R_m B_{pm}} \f$
     real(kr8) :: rblfacnr !< factor \f$ \frac{1}{2 \pi \lambda_{mid,near} R_m B_{pm}} \f$
     real(kr8) :: fpfacnr !< factor \f$ \frac{F P_{loss}}}{2 \pi \lambda_{mid,near} R_m B_{pm}} \f$
