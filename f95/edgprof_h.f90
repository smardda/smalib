...
! public variables
  integer(ki4), parameter :: MAX_NUMBER_OF_REGIONS=4 !< maximum number of regions allowed
...
!> type storing edge profile data
  type, public :: edgprof_t
     ...
     real(kr8),dimension(MAX_NUMBER_OF_REGIONS) :: rblfac !< factor \f$ \frac{1}{2 \pi \lambda_{mid} R_m B_{pm}} \f$
     real(kr8),dimension(MAX_NUMBER_OF_REGIONS) :: fpfac !< factor \f$ \frac{F P_{loss}}}{2 \pi \lambda_{mid} R_m B_{pm}} \f$
     real(kr8),dimension(MAX_NUMBER_OF_REGIONS) :: rblfacnr !< factor \f$ \frac{1}{2 \pi \lambda_{mid,near} R_m B_{pm}} \f$
     real(kr8),dimension(MAX_NUMBER_OF_REGIONS) :: fpfacnr !< factor \f$ \frac{F P_{loss}}}{2 \pi \lambda_{mid,near} R_m B_{pm}} \f$
     real(kr8),dimension(MAX_NUMBER_OF_REGIONS) :: slfac !< factor \f$ \frac{\sigma}{2 \lambda_{mid}} \f$
